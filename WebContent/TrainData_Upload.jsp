...
input[type=file]{
    ...
    function validate(){
    	var fname = document.getElementById("fff").value;
    	 if(fname.endsWith("Data.csv")){
    		 return true;
    	 }else{
    		 alert('Invalid Training Dataset !');
    		 return false;
    	 }
...
<body>
    ...
    <div id="home">
        ...
        <div class="hei">
				<div class="hei2"></div>
    	<form action="TrainingDataUpload" method="post" autocomplete="off" onsubmit="return validate()">
		<center> 
			<table id="customers">
  				<tr>      
        			<th>UPLOAD DATA</th>
        			<td><input type="file" name="traindata" id="fff" Value="CHOOSE FILE" required></td><br><td><input type="submit" value="LOAD DATA" ></td>
        		</tr>
        	</table>
        </center>
        </form>
      	    ...
      	    <div class="cpy-right">
        <p>                              <jsp:include page="WEB-INF/include/Footer.jsp"></jsp:include></p>
    </div>
    <!-- js -->
